		...
		try:			
			...
			if (self.payload["type"] == "REQ"):
				...
				if (self.payload["op"] == "LOGIN"):
					...
					# assetbalances = self.mc_conn.gettotalbalances()
					# message = {"sender":"SERVER","type":"RESP","op":"AST-BAL","details":{"ast-bal":assetbalances}}
					
				elif(self.payload["op"] == "AST-BAL"):
					assetbalances = self.mc_conn.gettotalbalances()
					message = {"sender":"SERVER","type":"RESP","op":"AST-BAL","details":{"ast-bal":assetbalances}}
...
if __name__ == '__main__':
	USER_DATA = {"thub":{"walletAddress":"1LVxQiuFLrHq5MuDKXvx2MAVWvKNUjvMFdkH2r","username":"thub","password":"123","mobile":"+919550119531"},
	      "3892":{"walletAddress":"1SDuiojwjRqUTyjJBTUWMUunTMjeptaU448ht6","username":"3892","password":"123","mobile":"+919550119531"},
	       }
